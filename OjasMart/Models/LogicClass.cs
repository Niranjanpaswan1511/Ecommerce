...
//
        ...
        public DataTable InsertOnlineProductDetailsNewUpdated(PropertyClass Objp, string ProcName, DataTable dt, DataTable dt1)
        {
           ...
           else
           {
            ...
            if (dtColorCodeList != null || dtSizeCodeList != null)
            {
                SqlParameter[] param = new SqlParameter[]
                {
                new SqlParameter("@Action",Objp.Action),
        ...
        internal DataTable InsertReview(string CustomerId, string CustomerName, string Description, string ProductCode, string ReviewStatus)
        {
            DataTable dt = new DataTable();
            SqlParameter[] parm = new SqlParameter[] {
        ...
        internal DataSet GetCustomerDashBoard(PropertyClass Objp, string ProcName)
        {
