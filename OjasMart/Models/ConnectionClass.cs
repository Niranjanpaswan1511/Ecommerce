...
namespace OjasMart.Models
{
    public class ConnectionClass
    {
        ...
        public string str = System.Configuration.ConfigurationManager.ConnectionStrings["DefaultNewCon"].ToString();
                ...
                new SqlParameter("@name",Name),
                  new SqlParameter("@EmailId",Email),
                    new SqlParameter("@mobileno",Mobile),
                      ...
                      new SqlParameter("@useReferCode",RefferCode),
                         new SqlParameter("@AccountType","Online"),

            };
            return db.ExecProcDataTable("[dbo].[CustomerApiRegistration]", parameter);
